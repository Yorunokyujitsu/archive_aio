...
PRODKEYS_URL="https://blog.kakaocdn.net/dn/bGhg8Q/btsJ94Q5pBH/wYEjf6F65UYGDbYHbkZbu0/${FILE_2}?attach=1&knm=tfile.keys"
...
DEEPSEA_URL="${BASE_URL}${TEAM_4}/DeepSea/${LATEST}/v${DEEPSEA_VER}/${FILE_17}"
